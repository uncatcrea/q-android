define( [ 'core/theme-app', 'core/modules/authentication', 'theme/authentication/js/common' ], function( App, Auth ) {
    ...
    /**
     * Here is implemented a "Premium posts" feature, meaning that the user can read
     * posts only if he's connected.
     *
